...
public class UpperTeethHapticEffects : MonoBehaviour
{
...
#if UNITY_EDITOR
[CustomEditor(typeof(UpperTeethHapticEffects))]
public class UpperTeethHapticEffectsEditor : Editor 
{
	override public void OnInspectorGUI()
	{
		UpperTeethHapticEffects HE = (UpperTeethHapticEffects)target;
		...
		{
			HE.effectType = (UpperTeethHapticEffects.EFFECT_TYPE)EditorGUILayout.EnumPopup("Effect Type", HE.effectType);


			switch (HE.effectType)
			{
			case UpperTeethHapticEffects.EFFECT_TYPE.CONSTANT:
