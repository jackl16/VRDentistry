...
public class UpperTeethHapticSurface : MonoBehaviour
{
	...
	void Start()
	{
		...
		{
			Debug.LogError("UpperTeethHapticSurface has been assigned to object without mesh.");
		}
...
[CustomEditor(typeof(UpperTeethHapticSurface))]
public class UpperTeethHapticSurfaceEditor : Editor
{
	override public void OnInspectorGUI()
	{
		UpperTeethHapticSurface HS = (UpperTeethHapticSurface)target;
		...
		{
			HS.hlTouchModel = (UpperTeethHapticSurface.HLTOUCH_MODEL)EditorGUILayout.EnumPopup("HL_Touch_Model", HS.hlTouchModel);
			HS.hlTouchable = (UpperTeethHapticSurface.HLFACING)EditorGUILayout.EnumPopup("HL_Facing", HS.hlTouchable);

			switch (HS.hlTouchModel)
			{
			case UpperTeethHapticSurface.HLTOUCH_MODEL.HL_CONTACT:
				...
				break;
			case UpperTeethHapticSurface.HLTOUCH_MODEL.HL_CONSTRAINT:
